...
async function triggersFrontRun(transaction, out_token_address, amount, level) {
    ...
    {   
        ...
        await updatePoolInfo();
        // calculate slippage
        let maxOutAmount = await pancakeRouter.methods.getAmountOut(in_amount.toString(), pool_info.input_volumn.toString(), pool_info.output_volumn.toString()).call();
        let slippage = (1 - out_min / maxOutAmount);
        ...
        let log_str2 = "outPutAmountCap: " + outPutAmountCap + "     *********************************************"
        console.log(log_str2.red);
        console.log(in_amount/(10**18));
        ...
        if(in_amount >= pool_info.attack_volumn && out_min >= outPutAmountCap)
    ...
    //function swapETHForExactTokens(uint amountOut, address[] calldata path, address to, uint deadline) external payable returns (uint[] memory amounts);
        ...
        let slippage = (1 - minAmountIn / in_max);
        let log_str1 = "slippage: " + (slippage * 100).toFixed(3) + "%"
        console.log(log_str1.red);
    ...
    else if(method == 'swapExactTokensForTokens')
    {
        ...
        //calculate slippage
        let maxOutAmount = await pancakeRouter.methods.getAmountOut(calc_eth.toString(), pool_info.input_volumn.toString(), pool_info.output_volumn.toString()).call();
        let slippage = (1 - out_min / maxOutAmount);
        let log_str1 = "slippage: " + (slippage * 100).toFixed(3) + "%"
        console.log(log_str1.red);
